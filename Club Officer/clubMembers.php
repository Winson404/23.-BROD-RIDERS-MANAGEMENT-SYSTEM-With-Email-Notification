                ...
                <tbody id="users_data">
                  ...
                  ?>
                        <tr>
                          ...
                          <td><?php echo $row['email']; ?> <br> <span class="text-info"><?php if ($row['contact'] !== '') {
                                                                                          echo '+63 ' . $row['contact'];
                                                                                        } ?></span></td>
                          <td>
                          ...
                          <td>
                            ...
                            <a class="btn btn-info btn-sm" href="clubMembers_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i></a>
                            ...
                            <!-- <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#password<?php //echo $row['user_Id']; 
                            ...
                            <?php if ($row['user_status'] == 0 && $row['account_status'] == 1) : ?>
                              <button type="button" class="btn btn-secondary btn-xs" data-toggle="modal" data-target="#active<?php echo $row['user_Id']; ?>">Set Active</button>
                            <?php elseif ($row['user_status'] == 1 && $row['account_status'] == 1): ?>
                              <button type="button" class="btn btn-secondary btn-xs" data-toggle="modal" data-target="#inactive<?php echo $row['user_Id']; ?>">Set Inactive</button>
                            <?php endif; ?>

                          </td>
                        </tr>

                      <?php include 'clubMembers_delete.php';
                      }
                    } else { ?>
                      <tr>
