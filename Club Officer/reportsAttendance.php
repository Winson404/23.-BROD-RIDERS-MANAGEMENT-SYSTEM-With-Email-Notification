<div class="content" id="table4" style="display: none;">
  <div class="row d-flex mb-3">
   ...
   <table id="example1" class="table table-bordered table-hover text-sm">
      ...
      <?php 
          $i = 1;
          $sql = mysqli_query($conn, "SELECT * FROM attendance JOIN users ON attendance.user_Id=users.user_Id WHERE users.user_type='Member' AND users.club='$cId' AND users.account_status=1 ORDER BY attendanceId DESC");
