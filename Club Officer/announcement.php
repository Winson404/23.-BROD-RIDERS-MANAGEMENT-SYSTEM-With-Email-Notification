<title>BROD RIDERS MS | Announcement records</title>
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        <?php if($row['actDate'] == $date_today): ?>
                          ...
                          <td class="bg-white text-justify text-bold"><?php echo $row['type']; ?></td>
                          <td class="bg-white text-justify text-bold"><?php echo $row['actName']; ?></td>
                          <td class="bg-white text-justify text-bold"><?php echo $row['description']; ?></td>
                          <td class="bg-white text-justify text-bold"><?php echo $row['note']; ?></td>
                          <td class="bg-white">
                        ...
                        <?php else: ?>
                          <td class="bg-grey text-bold"><?php echo date("F d, Y", strtotime($row['actDate'])); ?></td>
                          <td class="bg-grey text-justify text-bold"><?php echo $row['type']; ?></td>
                          <td class="bg-grey text-justify text-bold"><?php echo $row['actName']; ?></td>
                          <td class="bg-grey text-justify text-bold"><?php echo $row['description']; ?></td>
                          <td class="bg-grey text-justify text-bold"><?php echo $row['note']; ?></td>
                    ...
                    <?php include 'announcement_update_delete.php'; } } else { ?>
                      <tr>
                        <td colspan="100%" class="text-center">No announcement found</td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
