                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Member photo</b></span>
                              <div class="input-group">
        ...
        <div class="col-md-12">
          <form action="process_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a onclick="history.go(-1)" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                  <button type="submit" class="btn bg-primary" name="update_ClubMember" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
