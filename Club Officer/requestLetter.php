          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <button type="button" class="btn btn-sm bg-primary" data-toggle="modal" data-target="#add_activity"><i class="fa-sharp fa-solid fa-square-plus"></i> Attach event</button>
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php elseif($row['requestStatus'] == 2 && $row['reason'] != NULL): ?>
                          <span class="badge bg-gradient-danger pt-1">Denied</span> | 
                          <span type="button" class="badge bg-gradient-info pt-1" data-toggle="modal" data-target="#requestId<?php echo $row['requestId']; ?>">Reason for denial</span>
                        <?php else: ?>
                          <span class="badge bg-gradient-danger pt-1">Denied</span>
                        <?php endif; ?>
                      </td>
                    ...
                    <?php include 'requestLetter_reason.php'; } } else { ?>
                      <tr>
...
<?php include 'requestLetter_add.php'; include 'footer.php';  ?>
<!-- <script>
