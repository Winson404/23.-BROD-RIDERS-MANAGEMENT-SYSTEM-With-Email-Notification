          ...
          <div class="col-md-12">
            <div class="card">      
              ...
              <div class="card-footer float-right">
                <a href="clubMembers.php" class="btn bg-secondary"><i class="fa-solid fa-circle-left"></i> Back to list</a>
                <a class="btn btn-info" href="clubMembers_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
