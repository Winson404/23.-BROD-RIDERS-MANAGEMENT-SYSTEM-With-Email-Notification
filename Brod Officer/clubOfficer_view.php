          ...
          <div class="col-md-12">
            <div class="card">      
              <div class="card-body">
                  <div class="row p-2">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 text-dark">
                      ...
                      <p class="text-center text-sm text-muted">Club officer's photo</p>
                    </div>  
                  </div>
              ...
              <div class="card-footer float-right">
                <a href="clubOfficer.php" class="btn bg-secondary"><i class="fa-solid fa-circle-left"></i> Back to list</a>
                <a class="btn btn-info" href="clubOfficer_mgmt.php?page=<?php echo $row['user_Id']; ?>"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
