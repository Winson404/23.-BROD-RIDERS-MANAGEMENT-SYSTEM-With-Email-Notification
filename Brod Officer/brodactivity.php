              ...
              <div class="card-body p-3">
                  ...
                  <tbody id="users_data">
                    <?php 
                      $i = 1;
                      $club = $row['club'];
                      $sql = mysqli_query($conn, "SELECT * FROM clubactivity JOIN club ON clubactivity.club_Id=club.clubId JOIN users ON clubactivity.club_Officer_Id=users.user_Id");
                    ...
                    <?php include 'brodactivity_update_delete.php'; } } else { ?>
                      <tr>
...
<?php include 'brodactivity_add.php'; include 'footer.php';  ?>
<!-- <script>
