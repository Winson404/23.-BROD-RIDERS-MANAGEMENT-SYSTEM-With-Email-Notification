      ...
      <div class="modal-body">
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input name="clubName" class="form-control" placeholder="Enter Club name here..." required>
          </div>
          <div class="form-group">
            <span class="text-dark"><b>Club address</b></span>
            <input name="clubAddress" class="form-control" placeholder="Enter Club address here..." required>
          </div>
          <div class="form-group">
            <span class="text-dark"><b>Club description</b></span>
            <input name="clubDescription" class="form-control" placeholder="Enter Club description here...">
          </div>
      </div>
