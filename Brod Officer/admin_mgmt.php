<title>BROD RIDERS MS | Brod Officer info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
...
<?php if($page === 'create') { ?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>New Brod Officer</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Brod Officer info</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                          <a class="h5 text-primary"><b>BROD Officer's address</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Brod Officer photo</b></span>
                              <div class="input-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="club" required>
                              ...
                              ?>
                                  <option value="<?php echo $Clubrow['clubId']; ?>" ><?php echo $Clubrow['clubName']; ?></option>
                              <?php        
                                    }
                                  } else {
                              ?>
