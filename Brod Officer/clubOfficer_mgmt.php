<title>BROD RIDERS MS | Club officer info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
...
<?php if($page === 'create') { ?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>New Club officer</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Club officer info</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                          <a class="h5 text-primary"><b>Club Officer's address</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Club officer photo</b></span>
                              <div class="input-group">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a onclick="window.history.back()" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                    <button type="submit" class="btn bg-primary" name="create_clubOfficer" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <form action="process_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="club" required>
                              ...
                              <?php 
                                  $fetch = mysqli_query($conn, "SELECT * FROM club ORDER BY clubName");
                                  if(mysqli_num_rows($fetch) > 0) {
                                    while ($Clubrow = mysqli_fetch_array($fetch)) {
                              ?>
                                  <option value="<?php echo $Clubrow['clubId']; ?>" <?php if($Clubrow['clubId'] == $row['club']) { echo 'selected'; } ?>><?php echo $Clubrow['clubName']; ?></option>
                              <?php        
                                    }
                                  } else {
                              ?>
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a onclick="window.history.back()" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                  <button type="submit" class="btn bg-primary" name="update_clubOfficer" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
