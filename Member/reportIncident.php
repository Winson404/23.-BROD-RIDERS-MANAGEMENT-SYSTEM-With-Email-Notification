              ...
              <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Description of the injuries</b></span>
                              <textarea class="form-control" name="incidentinjuries" id="" cols="30" rows="2" placeholder="A description of the injuries." required></textarea>
                            </div>
                        </div>
