  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="announcement.php" class="nav-link">Home</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
...
?>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php 
        $MemberClubName = $row['club'];
        $get = mysqli_query($conn, "SELECT * FROM announcement WHERE clubId='$MemberClubName' AND (actDate > '$date_today' || actDate = '$date_today')");
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <?php if(mysqli_num_rows($get) == 1) : ?>
            <a type="button" href="announcement.php" class="dropdown-item dropdown-footer">See Announcement</a>
          <?php elseif(mysqli_num_rows($get) > 1): ?>
            <a type="button" href="announcement.php" class="dropdown-item dropdown-footer">See All Announcement</a>
          <?php endif; ?>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="announcement.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="direction.php" class="nav-link"><i class="fa-solid fa-road"></i>
              <p>&nbsp;Manage Ride Route
                <?php 
                  $club = $row['club'];
                  $ride = mysqli_query($conn, "SELECT * FROM ride_direction JOIN users ON ride_direction.added_by=users.user_Id WHERE (club='$club' || user_type='BROD') ORDER BY ride_id DESC");
          ...
          <li class="nav-item">
            <a href="reportIncident.php" class="nav-link"><i class="fa-solid fa-circle-info"></i><p>&nbsp;&nbsp; Report incident</p></a>
          </li>
        </ul>
      </nav>
      <!-- /.sidebar-menu -->
